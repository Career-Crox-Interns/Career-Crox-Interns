...
async function start() {
  ...
  const shouldBootstrapOnStart = String(process.env.BOOTSTRAP_ON_START || 'false').toLowerCase() === 'true';
  if (!shouldBootstrapOnStart) {
    updateBootstrap({ status: 'ready', readyAt: new Date().toISOString(), skipped: true });
