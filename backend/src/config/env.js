...
const fallbackSecretSeed = `${DATABASE_URL || 'career-crox'}|career-crox-stable-secret`;
const JWT_SECRET = String(process.env.JWT_SECRET || crypto.createHash('sha256').update(fallbackSecretSeed).digest('hex')).trim();
