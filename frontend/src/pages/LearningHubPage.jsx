...
const HUB_ROWS_BY_HUB = {
  learning: [
    ...
    { key: 'dark-psychology', label: 'Dark Psychology', tone: 'violet', help: 'Use ethical influence, urgency, and framing in a clear and natural way.' },
...
export default function LearningHubPage() {
  ...
  async function load() {
    try {
      const data = await api.get('/api/learning/hub', { cacheTtlMs: 10000 });
  ...
  return (
    <Layout title="YT Hub" subtitle="Learning, fun, and corporate video sections with daily rotating shorts, saved playlists, and a clean front page.">
      <style>{`
        ...
        .yt-video-thumb{width:100%;height:160px;object-fit:contain;background:linear-gradient(180deg,#eef4ff,#f8fbff);display:block;padding:8px;}
        ...
        .yt-short-card img{width:100%;height:120px;object-fit:contain;display:block;background:linear-gradient(180deg,#edf4ff,#f8fbff);padding:8px;}
