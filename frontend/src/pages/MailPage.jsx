        ...
        <div className="mail-shell">
          ...
          <div className="mail-panel">
            ...
            {activePanel !== 'logs' ? (
              ...
              <>
                <div className="mail-actions">
                  <button type="button" className="mail-btn ghost" onClick={async () => { try { await openManagerProtectedExport('/api/mail/export', 'mail/export'); } catch (error) { setMessage(error.message || 'Export failed.'); } }}>Export Logs</button>
                </div>
